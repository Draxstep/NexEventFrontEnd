...
import { Ticket, ArrowRight, Receipt, AlertCircle } from 'lucide-react';
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 min-h-screen">
            ...
            {loadingPurchases ? (
                ...
                <div className="space-y-12">
                    {/* Iteramos sobre purchases */}
                    {purchases.map((purchase) => (
                        <div key={purchase.purchaseId} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
                                ...
                                {purchase.generalQr && (
                                    <div className="flex items-center gap-3 bg-gray-50 p-2 rounded-lg border">
                                        ...
                                        <div className="text-xs">
                                            ...
                                            {/* Truncamos el QR para que no deforme la vista si es muy largo */}
                            ...
                            <div className="grid gap-6 md:grid-cols-1 lg:grid-cols-2">
                                {/* 7. Iteramos sobre tickets en lugar de boletos */}
